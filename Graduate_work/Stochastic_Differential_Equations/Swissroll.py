...
# -*- coding: utf-8 -*-
"""
Created on Wed Aug 11 13:11:01 2021

@author: jackmoody
"""
'''
Original Creator of code:
...
length_Z = 20     #length of swiss roll in z direction
...
plt.show()
#plt.savefig("/Users/jackmoody/Desktop/fig1.png")
...
data_plot(mydmap, dim=3, scatter_kwargs = {'cmap': 'Spectral'})
plt.show()
#plt.savefig("/Users/jackmoody/Desktop/fig2.png")
